 ...
 */
// SoftwareUart - 2 ports, same buffer sizes      : Nano compile size = 4176 Flash, 470 SRAM
// SoftwareUart - 2 ports, different buffer sizes : Nano compile size = 4868 Flash, 454 SRAM
#include <SoftwareUart.h>
#if defined(__AVR_ATtiny25__) | defined(__AVR_ATtiny45__) | defined(__AVR_ATtiny85__)
// PCMSK0 = [   -   |   -   | PCINT5| PCINT4| PCINT3| PCINT2| PCINT1| PCINT0]
//          [   -   |   -   |    RST|    PB4|    PB3|    PB2|    PB1|    PB0]
SoftwareUart<32> portOne(0, 1); // RX, TX
SoftwareUart<> portTwo(2, 3); // RX, TX
#elif defined(__AVR_ATmega16U4__) | defined(__AVR_ATmega32U4__)
// PCMSK0 = [ PCINT7| PCINT6| PCINT5| PCINT4| PCINT3| PCINT2| PCINT1| PCINT0]
//          [    D12|    D11|    D10|     D9|   MISO|   MOSI|    SCK|     SS]
SoftwareUart<32> portOne(9, 10); // RX, TX
